...
export default function LandingScreen({ onStart }: { onStart: () => void }) {
  ...
  <img src="/Logo.svg" alt="CRISP AI Logo" className="w-24 h-24 mb-4" />
  <h1 className="text-4xl font-bold text-gray-800 mb-2 text-center drop-shadow-lg">Welcome to CRISP AI</h1>
